...
export class UsersdataController {
  ...
  filteredusersdata(
    @Body('searchquery') searchquery: any,
    @Body('userlocation') userlocation: any,
    @Body('userid') userid: any
  ): Promise<any> {
    return this.usersdataService.filteredusersdata(
      searchquery,
      userlocation,
      userid
    )
  ...
  acceptingconnection(
    @Body('userid') userid: any,
    @Body('connectionid') connectionid: any
  ): Promise<any> {
